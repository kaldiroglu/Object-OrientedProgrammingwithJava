package org.javaturk.oopj.ch02.access;


import org.javaturk.oopj.ch02.access.aPackage.Parent2;
...
//		Parent1.sv(); // Never!
	...
	public void printParentClassInfo2(Parent2 pc) {
		System.out.println("pc.x: " + pc.x);
//		System.out.println("pc.y: " + pc.y); // Only when they are in the same package
//		System.out.println("pc.t: " + pc.t); // It is not accessible because it is not public.
//		System.out.println("pc.z: " + pc.z); // Never!
