package org.javaturk.oopj.ch13.runtime;

import org.javaturk.oopj.ch13.runtime.shape1.Circle;
import org.javaturk.oopj.ch13.runtime.shape1.NegativeArgumentException;
import org.javaturk.oopj.ch13.runtime.shape1.Shape;
...
//	}
    ...
    public static void produceStringIndexOutOfBoundsException() {
        ...
        for (int i = 0; i < s.length(); i++) // Use s.length()
            System.out.println(s.charAt(i));

        for (int i = 0; i <= s.length() - 1; i++) // Use s.length()
            System.out.println(s.charAt(i));
    }
}
