...
//		addSetToSet();
	...
	public static void processSet() {
		...
		System.out.println(set.add(3)); // Should return false!
...
//		Set<String> set = Set.of("Mehmet", "Zeynep", "Tarik", "Ahmet", "Zeynep");
...
//		Set<String> set2 = Set.of("Mehmet", "Zeynep", "Tarik", null); // NullPointerException
	...
	public static void addSetToSet() {
		...
		System.out.println("\nIterating set1 through forEach:");
		...
		System.out.println("\nIterating set2 through forEach:");
		set2.forEach(System.out::println);
		
		System.out.println("\nAdding set2 to the set1");
//		System.out.println(set1.addAll(set2));

		System.out.println(set1.add(set2)); // true
//		System.out.println(set1.add(set2)); // false
